            ...
            <div class="col-md-6 m-auto">
                <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative ">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <div class="mb-1 text-muted">{{$post->created_at}} by <a href="">{{$post->user}}</a></div>
                        <p class="card-text mb-auto">
                            {{substr($post->content,0,90)}}...
                        </p>
                        <p class="card-text mb-auto">({{count(\App\Comment::where('post_id', $post->id)->get())}}) <span
                                class="card-text">Ý kiến bạn đọc</span></p>

                        <a href="{{route('posts.view',$post->id)}}" class="stretched-link">Continue reading</a>
                    </div>
